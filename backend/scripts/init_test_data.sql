INSERT INTO `fbb`.`sys_dept` (`id`, `name`, `level`, `sort`, `leader`, `phone`, `email`, `status`, `del_flag`, `parent_id`, `created_time`, `updated_time`)
VALUES (1, 'test', 0, 0, NULL, NULL, NULL, 1, 0, NULL, '2023-06-26 17:13:45', NULL);

INSERT INTO `fbb`.`sys_api` (`id`, `name`, `method`, `path`, `remark`, `created_time`, `updated_time`)
...
INSERT INTO `fbb`.`sys_menu` (`id`, `title`, `name`, `level`, `sort`, `icon`, `path`, `menu_type`, `component`, `perms`, `status`, `show`, `cache`, `remark`, `parent_id`, `created_time`, `updated_time`)
...
-- 密码明文：123456
INSERT INTO `fbb`.`sys_user` (`id`, `uuid`, `username`, `nickname`, `password`, `salt`, `email`, `is_superuser`, `is_staff`, `status`, `is_multi_login`, `avatar`, `phone`, `join_time`, `last_login_time`, `dept_id`, `created_time`, `updated_time`)
...
INSERT INTO `fbb`.`sys_user_role` (`id`, `user_id`, `role_id`) VALUES (1, 1, 1);
